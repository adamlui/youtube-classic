    ...
    unround: {
        ...
        get css() {
            return !app.config.unroundCorners ? '' : `
                ...
                :where(div#subscribe-button, yt-flexible-actions-view-model) :is(a, .ytSubscribeButtonViewModelContainer > button).ytSpecButtonShapeNextHost:not(:has(path[d^="M12 23c6.075"])) {
